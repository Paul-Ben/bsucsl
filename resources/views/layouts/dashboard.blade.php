...
<head>
    ...
    <link href="{{asset('db/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{asset('db/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css')}}" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{asset('db/css/bootstrap.min.css')}}" rel="stylesheet">
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>E-Learning</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <!-- =====================================
                     ...
                     you can delete the field including it's fils,
                     or use it how ever you want to
                     ========================================== -->
                    <!-- <div class="nav-item dropdown">
                                    ...
                                    <td>
                                        <div class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="delete_student.html" class="dropdown-item">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Benue State University, Makurdi.</a>, All Rights Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed By <a href="#">Directorate of ICT</a>
                        </br>
    ...
    <script src="{{asset('db/lib/chart/chart.min.js')}}"></script>
    <script src="{{asset('db/lib/easing/easing.min.js')}}"></script>
    <script src="{{asset('db/lib/waypoints/waypoints.min.js')}}"></script>
    <script src="{{asset('db/lib/owlcarousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('db/lib/tempusdominus/js/moment.min.js')}}"></script>
    <script src="{{asset('db/lib/tempusdominus/js/moment-timezone.min.js')}}"></script>
    <script src="{{asset('db/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js')}}"></script>
